...
function initSwiperProjects() {
  ...
  swiperEl.addEventListener("focusin", () => isActive = true);
  swiperEl.addEventListener("mouseenter", () => isActive = true);
  swiperEl.addEventListener("mouseleave", () => isActive = false);
